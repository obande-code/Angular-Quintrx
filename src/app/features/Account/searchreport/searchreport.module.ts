...
import { SearchreportRoutingModule } from './searchreport-routing.module';
...
@NgModule({
    ...
    imports: [CommonModule, SearchreportRoutingModule, FormsModule, ReactiveFormsModule, MatTableModule, MatToolbarModule
