...
@Component({
  selector: 'app-ssa89',
  templateUrl: './ssa89.component.html',
  styleUrls: ['./ssa89.component.scss']
})
export class Ssa89Component implements OnInit {
  ...
  sign()
  {
    ...
    {
      this.msg = "Please enter your valid 9 digit Social Security #"
      this.showMsg = true
    }
    else if(!this.disclosureData.morgage && !this.disclosureData.bankAccount && !this.disclosureData.retirement && !this.disclosureData.job
      && !this.disclosureData.creditCard && !this.disclosureData.licensing && !this.disclosureData.Other)
    {
      this.msg = "Please select at least one box"
      this.showMsg = true
    }
    else if(!this.disclosureData.companyName)
    {
      this.msg = "Please enter the company name"
      this.showMsg = true
    }
    else if(!this.disclosureData.companyAddress || checkZeros.test(this.disclosureData.companyAddress))
    {
      this.msg = "Please enter a valid company address"
      this.showMsg = true
    }
    else if(!this.disclosureData.signature)
    {
      this.msg = "Please enter your signature"
      this.showMsg = true
    }
    else if(!this.disclosureData.ssnagain)
    {
