...
@Component({
  selector: 'app-summaryofconsumerrights',
  templateUrl: './summaryofconsumerrights.component.html',
  styleUrls: ['./summaryofconsumerrights.component.scss']
})
export class SummaryofconsumerrightsComponent implements OnInit {
